...
setInterval(function(){
    ...
    var billdate = moment().format('YYYYMM');
    //console.log(date);
    if (pin == 1){
        second = t.end();
        console.log('data : ' + elec + 'end : ' + second);
        pin = 0;
    }

    web3.personal.unlockAccount(Owner, "1");
    crowd.datasender.sendTransaction(users, elec, date, second, billdate, {
        from: Owner,
        gas: 500000
    });
